...
.nav_hamburger-page.ham_active .ham_show{
...
.ham_search .search_icon{
    position: absolute;
    top: 12px;
    left: 17px;
}
.nav_hamburger_ul .ham_page-link{
    padding: 14px 0;
